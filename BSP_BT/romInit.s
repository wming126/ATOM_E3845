...
--------------------
01i,14jan13,rbc  WIND00381053 - Fix A20 enable move code to
                 target/src/hwif/cpu/arch/i86
01h,23nov12,yjw  Fix booting from grub multiboot failed.
                 (WIND00380360)
01g,31aug12,g_x  make romWarmHigh as the entry from first boot 
                 stage (WIND00332348)
01f,20apr12,jjk  WIND00329365 - Support for SMP
01e,31mar12,c_t  fix opcode problem for real mode.(WIND00332346)
01d,17nov11,wyt  modify romA20on and romWait.
01c,21jun11,c_t  modify romA20on.(WIND00278191)
...
multiboot_header:
	...
	.balign 16,0x90
        ...
        /* GRUB cold boot entry, fix near jump defect */
...
romInit2:
...
#else /* GRUB_MULTIBOOT */
	movl    $ STACK_ADRS,%esp   /* set a stack pointer */
#endif /* GRUB_MULTIBOOT */
    ...
    /* when boot from GRUB, no need to check A20 gate. Grub has opened it. */
...
1:
    ...
    /* Have loaded Grub temp GDT and load bootrom though ELF info */ 
